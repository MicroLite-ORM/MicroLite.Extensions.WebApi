...
// </copyright>
// -----------------------------------------------------------------------
namespace MicroLite.Extensions.WebApi.OData.Query
{
    /// <summary>
    ...
    public sealed class OrderByProperty
    {
        ...
        /// <exception cref="MicroLite.Extensions.WebApi.Query.ODataException">If supplied, the direction should be either 'asc' or 'desc'.</exception>
